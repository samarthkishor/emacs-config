...
** Mode line
   ...
   #+begin_src emacs-lisp
     (use-package emacs
       ...
       ;; Remove recursion indicators
       ;; REVIEW: maybe there is a cleaner way to handle this
...
** Editing
   ...
   #+begin_quote
   Emacs labels as “electric” any behavior that involves contextual auto-insertion of characters. 
   #+end_quote
